...
class UserController extends AdminBaseController
{
    ...
    {
        $users = $this->paginator($this->name);
        return $this->renderTpl($this->name . ':index', compact('users'));
    }
    ...
    public function addAction()
    {
        ...
        return $this->renderTpl($this->name . ':add', compact('form'));
    }

    public function editAction($id)
    {

        $user = $this->findOne($this->name, $id);
        $form = $this->getForm($this->name, $user);
